    ...
    <section className="py-20">
      <div className="container mx-auto px-5">
        <div className="flex flex-col gap-5 mx-auto md:w-[700px]">
          <h1 className="max-sm:text-3xl text-4xl text-center font-bold text-[#0F0049]">
            Meet our dream team
          </h1>
          <p className="text-center max-sm:text-sm text-opacity-80 md:px-20">
        ...
        <div className="pt-20 pb-20">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-sm:gap-3 gap-6">
            {teamsData.map(({ designation, image, name }, index) => (
              <div key={index} className="">
                ...
                <div className="mt-4 pb-4 text-center">
                  <h3 className="font-semibold max-sm:text-lg text-xl text-[#0F0049]">
                    {name}
                  </h3>
      ...
      <div className="container mx-auto px-5">
        <div className="bg-[#F6F5F8] shadow-md rounded-lg py-10 border border-[#EAEAEA] max-md:px-5 px-20">
          <div className="flex max-md:flex-col max-md:gap-4">
            ...
            <div className="flex-1 flex flex-col gap-6">
              <p className="text-[#0F0049] font-medium text-opacity-75 max-sm:text-sm">
              ...
              <Link
                href="/"
                className="flex items-center gap-4 text-[#F63A61] max-sm:text-sm font-semibold"
              >
